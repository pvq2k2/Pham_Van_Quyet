...
<div className="header fixed right-0 left-0 z-[1030] bg-slate-50 dark:bg-[#1F2235] transition duration-500">
  ...
  <div className="slicknav_menu flex justify-between sm:hidden">
    <div onClick={() => setTheme(colorTheme)} className="toggle mt-3 h-5 w-5">
  {colorTheme === 'light' ? (
...
<div>
  <div className="mt-[10px] ml-2 transition duration-300" onClick={() => setNavToggle(!navToggle)}>
{navToggle ? (
...
<i className="bx bx-x text-3xl text-[#3e6ff4] cursor-pointer" />
  ...
  : "lg:hidden xl:hidden visible fixed top-[50px] right-0 left-0 bottom-0 bg-black/30 z-20"} onClick={() => setNavToggle(!navToggle)}>
    ...
    <div id="nav__menu" className="sm:my-5 mr-4 hidden sm:flex transition duration-300">
      ...
      <div onClick={() => setTheme(colorTheme)} className="toggle my-1 ml-2 h-5 w-5">
  {colorTheme === 'light' ? (
    <i className="bx bx-sun text-2xl text-[#3e6ff4] cursor-pointer" />
  ): (
    <i className="bx bx-moon text-2xl text-[#3e6ff4] cursor-pointer" />
