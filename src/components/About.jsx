...
const About = () => {
  return (
      <section className="pt-20 pb-40 bg-slate-50 dark:bg-[#1F2235] transition duration-500" id="about">
          <h2 className="relative text-3xl text-center text-[#3e6ff4] mt-4 mb-8 font-extrabold 
          after:absolute after:w-16 after:h-[3px] after:left-0 after:right-0 after:m-auto after:top-10 after:bg-[#3e6ff4]">About</h2>
          ...
          <img className="w-[200px] rounded-lg" src="https://i.postimg.cc/FHpjqR1Y/Alcidesmarcio.jpg" alt />
    </div>
    <div>
