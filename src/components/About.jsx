...
const About = () => {
  return (
      <section className="pt-20 pb-40 bg-slate-50 dark:bg-[#1F2235] transition duration-500" id="about">
          ...
          after:absolute after:w-16 after:h-[3px] after:left-0 after:right-0 after:m-0 after:ml-4 after:top-10 after:bg-[#3e6ff4] sm:after:m-auto sm:after:ml-0">About</h2>
